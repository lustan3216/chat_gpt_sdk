...
main() {
  ...
  group('GeneratedImageSize', () {
    test('normal', () {
      ...
      expect(
        GenerateImage('test', 2, model: DallE3(), size: ImageSize.size256).size?.size,
        '256x256',
      );
      expect(
        GenerateImage('test', 2, model: DallE3(), size: ImageSize.size512).size?.size,
        '512x512',
      );
      expect(
        GenerateImage('test', 2, model: DallE3(), size: ImageSize.size1024).size?.size,
        '1024x1024',
      );
    });
  });
