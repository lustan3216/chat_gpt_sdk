import 'package:chat_gpt_sdk_lululala/src/model/fine_tune/response/fine_tune_event.dart';
import 'package:chat_gpt_sdk_lululala/src/model/fine_tune/response/fine_tune_hyper_params.dart';
import 'package:chat_gpt_sdk_lululala/src/model/fine_tune/response/training_files.dart';
...
class FineTuneModel {
  ...
  factory FineTuneModel.fromJson(Map<String, dynamic> json) {
    return FineTuneModel(
      ...
      events: (json['events'] as List?)?.map((e) => FineTuneEvent.fromJson(e)).toList(),
      fineTunedModel: json['fine_tuned_model'],
      hyperparams: FineTuneHyperParams.fromJson(json['hyperparams']),
      organizationId: json['organization_id'],
      resultFiles: (json['result_files'] as List).map((e) => e.toString()).toList(),
      status: json['status'],
      validationFiles: (json['validation_files'] as List).map((e) => e.toString()).toList(),
      trainingFiles: (json['training_files'] as List).map((e) => TrainingFiles.fromJson(e)).toList(),
