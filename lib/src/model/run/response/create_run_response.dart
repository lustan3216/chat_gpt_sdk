...
import 'package:chat_gpt_sdk_lululala/src/model/run/response/step_detail.dart';
...
class CreateRunResponse {
  ...
  factory CreateRunResponse.fromJson(Map<String, dynamic> json) => CreateRunResponse(
        ...
        type: json['type'] ?? '',
        stepDetails: json['step_details'] == null ? null : StepDetail.fromJson(json['step_details']),
