...
import 'package:chat_gpt_sdk_lululala/src/model/file/response/delete_file.dart';
import 'package:chat_gpt_sdk_lululala/src/model/message/request/create_message.dart';
import 'package:chat_gpt_sdk_lululala/src/model/message/response/create_message_response.dart';
import 'package:chat_gpt_sdk_lululala/src/model/message/response/list_message_file.dart';
import 'package:chat_gpt_sdk_lululala/src/model/message/response/list_message_file_data.dart';
import 'package:chat_gpt_sdk_lululala/src/model/message/response/message_data.dart';
import 'package:chat_gpt_sdk_lululala/src/model/message/response/message_data_response.dart';
...
class MessagesV2 {
  ...
  MessagesV2({required OpenAIClient client, required Map<String, String> headers})
      : _client = client,
        _headers = headers;
  ...
  Future<MessageDataResponse> listMessage({
    ...
    String url = _client.apiUrl + kThread + "/$threadId/$kMessages?limit=$limit&order=$order";
...
class Messages {
  ...
  Future<ListMessageFile> listMessageFile({
    ...
    String url = _client.apiUrl + kThread + "/$threadId/$kMessages/$messageId/$kFile?limit=$limit&order=$order";
  ...
  Future<ListMessageFileData> retrieveMessageFile({
    ...
    return _client.get(
      _client.apiUrl + kThread + "/$threadId/$kMessages/$messageId/$kFile/$fileId",
      headers: _headers,
